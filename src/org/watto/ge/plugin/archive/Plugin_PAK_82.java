...
**********************************************************************************************
**/
public class Plugin_PAK_82 extends ArchivePlugin {
  ...
  **/
  public Plugin_PAK_82() {
    ...
    setGames("Haunted Hotel II: Believe the Lies");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readInt() == -105896560) {
        rating += 50;
      }

      if (fm.readInt() == 1699967073) {
        rating += 5;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      // Set the XOR
      int[] xorKey = new int[] { 80, 111, 112, 67, 97, 112, 83, 101, 120, 121, 70, 114, 97, 109, 101, 119, 111, 114, 107 };
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        int keyPos = ((int) offset) % 19; // 19 is the key length
