...
**********************************************************************************************
**/
public class Plugin_PAK_PAK_8 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_PAK_PAK_8() {

    super("PAK_PAK_8", "PAK_PAK_8");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Echoes of Sorrow");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // 1 - Description Length (42)
      if (fm.readByte() == 42) {
        rating += 5;
      }

      // 42 - Description ("Package Builder v1.0 Coded by Rui Barbosa.")
      if (fm.readString(42).equals("Package Builder v1.0 Coded by Rui Barbosa.")) {
        rating += 5;
      }
