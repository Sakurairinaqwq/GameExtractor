...
**********************************************************************************************
**/
public class Plugin_PAK_80 extends ArchivePlugin {
  ...
  public Resource[] read(File path) {
    try {
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        // 4 - Compressed File Length (including all the following fields, but NOT including this field)
        int length = fm.readInt();
        FieldValidator.checkLength(length, arcSize);

        // 4 - Decompressed Block Size? (131072)
        int decompLength = fm.readInt();
        FieldValidator.checkLength(decompLength);

        // 4 - Compressed Block Length
        int blockLength = fm.readInt();
        FieldValidator.checkLength(blockLength, length);
