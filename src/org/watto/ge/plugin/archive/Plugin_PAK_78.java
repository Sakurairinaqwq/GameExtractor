...
**********************************************************************************************
**/
public class Plugin_PAK_78 extends ArchivePlugin {
  ...
  **/
  ...
  public FileManipulator decompressArchive(FileManipulator fm) {
    try {
      ...
      byte[] key = new byte[] { (byte) 134, (byte) 135, 3, (byte) 169, (byte) 148, 61, 115, (byte) 239, 107, (byte) 223, 120, (byte) 175, (byte) 163, (byte) 235, (byte) 165, 56 };
      Exporter_Encryption_AES exporter = new Exporter_Encryption_AES(key);
  ...
  public Resource[] read(File path) {
    try {
      ...
      Resource[] resources = new Plugin_ZIP_PK().read(fm.getFile());
