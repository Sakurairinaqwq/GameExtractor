...
**********************************************************************************************
**/
public class Plugin_PAK_PAK_9 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_PAK_PAK_9() {

    super("PAK_PAK_9", "PAK_PAK_9");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Artifact Quest",
        "Artifact Quest 2");
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      // now that we have the end of the directory, set the offsets appropriately
