...
**********************************************************************************************
**/
public class Plugin_ZCA_ZCA_4 extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_ZCA_ZCA_4() {

    super("ZCA_ZCA_4", "ZCA_ZCA_4");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Hotel Mogul: Las Vegas");
  ...
  **/
  ...
  public Resource[] read(File path) {
    try {
      ...
      // Set the XOR key
      int[] xorKey = new int[] { 53, 116, 119, 52, 116, 50, 52, 100, 122, 106, 115, 100, 112, 51, 64, 117, 52, 107, 100, 121, 109, 118, 107, 52, 35, 40, 64, 94, 115, 105, 64, 56, 55, 114, 55, 56, 114, 116, 50, 53, 116, 103, 117, 105, 118, 100, 115, 42, 102, 115, 100, 103, 52, 115, 102, 36, 118, 119, 101 };
