...
**********************************************************************************************
**/
public class Plugin_BIN_RESOURCESPACK extends ArchivePlugin {
  ...
  **********************************************************************************************
  **/
  public Plugin_BIN_RESOURCESPACK() {

    super("BIN_RESOURCESPACK", "BIN_RESOURCESPACK");

    //         read write replace rename
    setProperties(true, false, false, false);

    setGames("Airport Mania");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readString(14).equals("RESOURCES PACK")) {
        rating += 50;
      }
