...
**********************************************************************************************
**/
public class Plugin_IMG_5 extends ArchivePlugin {
  ...
  **/
  public Plugin_IMG_5() {
    ...
    setEnabled(false); // NOT WORKING YET
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      getDirectoryFile(fm.getFile(), "LVZ");
      rating += 25;
  ...
  public Resource[] read(File path) {
    try {
      ...
      while (fm.getOffset() < arcSize) {
        ...
        System.out.println("Offset2:" + nextOffset);
