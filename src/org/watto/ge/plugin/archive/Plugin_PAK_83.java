...
**********************************************************************************************
**/
public class Plugin_PAK_83 extends ArchivePlugin {
  ...
  **/
  public Plugin_PAK_83() {
    ...
    setGames("Haunted Hotel: Lonely Dream");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      // Header
      if (fm.readInt() == -293395839) {
        rating += 50;
      }

      if (fm.readInt() == 1194546293) {
        rating += 5;
      }
  ...
  public Resource[] read(File path) {
    try {
      ...
      // Set the XOR
      int[] xorKey = new int[] { 65, 104, 67, 84, 117, 84, 51, 71, 53, 35, 85, 105, 51, 80, 48, 57, 66, 103, 105, 85, 105, 79, 53 };
      ...
      for (int i = 0; i < numFiles; i++) {
        ...
        int keyPos = ((int) offset) % 23; // 23 is the key length
