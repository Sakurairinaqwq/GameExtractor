...
import org.watto.ge.plugin.archive.Plugin_PAK_EEPAK_3;
...
**********************************************************************************************
**/
public class Viewer_PAK_EEPAK_3_DDS_DDS extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_PAK_EEPAK_3_DDS_DDS() {
    super("PAK_EEPAK_3_DDS_DDS", "PAK_EEPAK_3_DDS_DDS Image");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_PAK_EEPAK_3) {
        rating += 50;
      }
      else {
        return 0;
      ...
      if (fm.readString(4).equals("DDS ")) {
        rating += 24; // only want to match within this specific plugin
      }
      else {
        rating = 0;
      }
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      //
      //
      // THIS IS WHERE IT DIFFERS FROM STANDARD DDS.
      // SPECIFICALLY, THE IMAGE DATA IS COMPRESSED WITH SNAPPY.
      //
      //
      //

      // Images are DXT5 single mipmap (or so they seem), so use that as the decomp length that we're aiming for
      int length = (int) fm.getLength() - 128;
      int decompLength = width * height;

      // decompress the data
      byte[] dirBytes = new byte[decompLength];
      int decompWritePos = 0;
      Exporter_Snappy exporter = Exporter_Snappy.getInstance();
      ...
      if (dxgiFormat != 0) {
        ...
        if (dxgiFormat == 1) {
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G32B32A32_TYPELESS");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G32B32A32_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 4) {
          // DXGI_FORMAT_R32G32B32A32_SINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G32B32A32_SINT");
          throw new Exception();
        }
        else if (dxgiFormat == 5) {
          // DXGI_FORMAT_R32G32B32_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G32B32_TYPELESS");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G32B32_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 8) {
          // DXGI_FORMAT_R32G32B32_SINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G32B32_SINT");
          throw new Exception();
        }
        else if (dxgiFormat == 9) {
          // DXGI_FORMAT_R16G16B16A16_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16G16B16A16_TYPELESS");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16G16B16A16_UNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 12) {
          // DXGI_FORMAT_R16G16B16A16_UINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16G16B16A16_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 13) {
          // DXGI_FORMAT_R16G16B16A16_SNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16G16B16A16_SNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 14) {
          // DXGI_FORMAT_R16G16B16A16_SINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16G16B16A16_SINT");
          throw new Exception();
        }
        else if (dxgiFormat == 15) {
          // DXGI_FORMAT_R32G32_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G32_TYPELESS");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G32_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 18) {
          // DXGI_FORMAT_R32G32_SINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G32_SINT");
          throw new Exception();
        }
        else if (dxgiFormat == 19) {
          // DXGI_FORMAT_R32G8X24_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32G8X24_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 20) {
          // DXGI_FORMAT_D32_FLOAT_S8X24_UINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_D32_FLOAT_S8X24_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 21) {
          // DXGI_FORMAT_R32_FLOAT_X8X24_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32_FLOAT_X8X24_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 22) {
          // DXGI_FORMAT_X32_TYPELESS_G8X24_UINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_X32_TYPELESS_G8X24_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 23) {
          // DXGI_FORMAT_R10G10B10A2_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R10G10B10A2_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 24) {
          // DXGI_FORMAT_R10G10B10A2_UNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R10G10B10A2_UNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 25) {
          // DXGI_FORMAT_R10G10B10A2_UINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R10G10B10A2_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 26) {
          // DXGI_FORMAT_R11G11B10_FLOAT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R11G11B10_FLOAT");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 40) {
          // DXGI_FORMAT_D32_FLOAT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_D32_FLOAT");
          throw new Exception();
        }
        else if (dxgiFormat == 41) {
          // DXGI_FORMAT_R32_FLOAT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32_FLOAT");
          throw new Exception();
        }
        else if (dxgiFormat == 42) {
          // DXGI_FORMAT_R32_UINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 43) {
          // DXGI_FORMAT_R32_SINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R32_SINT");
          throw new Exception();
        }
        else if (dxgiFormat == 44) {
          // DXGI_FORMAT_R24G8_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R24G8_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 45) {
          // DXGI_FORMAT_D24_UNORM_S8_UINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_D24_UNORM_S8_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 46) {
          // DXGI_FORMAT_R24_UNORM_X8_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R24_UNORM_X8_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 47) {
          // DXGI_FORMAT_X24_TYPELESS_G8_UINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_X24_TYPELESS_G8_UINT");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 54) {
          // DXGI_FORMAT_R16_FLOAT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16_FLOAT");
          throw new Exception();
        }
        else if (dxgiFormat == 55) {
          // DXGI_FORMAT_D16_UNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_D16_UNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 56) {
          // DXGI_FORMAT_R16_UNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16_UNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 57) {
          // DXGI_FORMAT_R16_UINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16_UINT");
          throw new Exception();
        }
        else if (dxgiFormat == 58) {
          // DXGI_FORMAT_R16_SNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16_SNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 59) {
          // DXGI_FORMAT_R16_SINT
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R16_SINT");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R1_UNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 67) {
          // DXGI_FORMAT_R9G9B9E5_SHAREDEXP
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R9G9B9E5_SHAREDEXP");
          throw new Exception();
        }
        else if (dxgiFormat == 68) {
          // DXGI_FORMAT_R8G8_B8G8_UNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R8G8_B8G8_UNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 69) {
          // DXGI_FORMAT_G8R8_G8B8_UNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_G8R8_G8B8_UNORM");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_BC4_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 80) {
          // DXGI_FORMAT_BC4_UNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_BC4_UNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 81) {
          // DXGI_FORMAT_BC4_SNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_BC4_SNORM");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_B8G8R8X8_UNORM");
          throw new Exception();
        }
        else if (dxgiFormat == 89) {
          // DXGI_FORMAT_R10G10B10_XR_BIAS_A2_UNORM
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_R10G10B10_XR_BIAS_A2_UNORM");
          throw new Exception();
        }
          ...
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_B8G8R8X8_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 93) {
          // DXGI_FORMAT_B8G8R8X8_UNORM_SRGB
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_B8G8R8X8_UNORM_SRGB");
          throw new Exception();
        }
        else if (dxgiFormat == 94) {
          // DXGI_FORMAT_BC6H_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_BC6H_TYPELESS");
          throw new Exception();
        }
        else if (dxgiFormat == 95) {
          // DXGI_FORMAT_BC6H_UF16
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_BC6H_UF16");
          throw new Exception();
        }
        else if (dxgiFormat == 96) {
          // DXGI_FORMAT_BC6H_SF16
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_BC6H_SF16");
          throw new Exception();
        }
        else if (dxgiFormat == 97) {
          // DXGI_FORMAT_BC7_TYPELESS
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_BC7_TYPELESS");
          throw new Exception();
        }
          ...
          // DXGI_FORMAT_AYUV
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_AYUV");
          throw new Exception();
        }
        else if (dxgiFormat == 101) {
          // DXGI_FORMAT_Y410
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_Y410");
          throw new Exception();
        }
        else if (dxgiFormat == 102) {
          // DXGI_FORMAT_Y416
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_Y416");
          throw new Exception();
        }
        else if (dxgiFormat == 103) {
          // DXGI_FORMAT_NV12
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_NV12");
          throw new Exception();
        }
        else if (dxgiFormat == 104) {
          // DXGI_FORMAT_P010
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_P010");
          throw new Exception();
        }
        else if (dxgiFormat == 105) {
          // DXGI_FORMAT_P016
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_P016");
          throw new Exception();
        }
        else if (dxgiFormat == 106) {
          // DXGI_FORMAT_420_OPAQUE
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_420_OPAQUE");
          throw new Exception();
        }
        else if (dxgiFormat == 107) {
          // DXGI_FORMAT_YUY2
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_YUY2");
          throw new Exception();
        }
        else if (dxgiFormat == 108) {
          // DXGI_FORMAT_Y210
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_Y210");
          throw new Exception();
        }
        else if (dxgiFormat == 109) {
          // DXGI_FORMAT_Y216
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_Y216");
          throw new Exception();
        }
        else if (dxgiFormat == 110) {
          // DXGI_FORMAT_NV11
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_NV11");
          throw new Exception();
        }
        else if (dxgiFormat == 111) {
          // DXGI_FORMAT_AI44
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_AI44");
          throw new Exception();
        }
        else if (dxgiFormat == 112) {
          // DXGI_FORMAT_IA44
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_IA44");
          throw new Exception();
        }
          ...
          // DXGI_FORMAT_P208
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_P208");
          throw new Exception();
        }
        else if (dxgiFormat == 131) {
          // DXGI_FORMAT_V208
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_V208");
          throw new Exception();
        }
        else if (dxgiFormat == 132) {
          // DXGI_FORMAT_V408
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: DXGI_FORMAT_V408");
          throw new Exception();
        }
        else {
          // Unsupported format
          ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: DX10: " + dxgiFormat);
          throw new Exception();
        }
        ...
        if (/*flags2 == 32 &&*/ rgbBitCount == 8) {
          ...
          if (fourCCint == 15) {
            ...
            // Unsupported format
            ErrorLogger.log("[Viewer_PAK_EEPAK_3_DDS_DDS]: Unsupported Format: " + fourCC);
            throw new Exception();
          }
        }
      }
      ...
      //
      // THIS IS WHERE IT DIFFERS FROM STANDARD DDS.
      // SPECIFICALLY, THE IMAGE NEEDS TO BE FLIPPED VERTICALLY
      //
      //
      //
