...
**********************************************************************************************
**/
public class Viewer_PIC_Ignition extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_PIC_Ignition() {
    super("PIC_Ignition", "Ignition PIC Image");
    setExtensions("pic");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (FieldValidator.checkEquals(fm.readInt(), 776)) {
        rating += 5;
      }
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // 2 - Unknown
      // 4 - null
      // 2 - Image Type? (8=paletted)
      // 44 - null
      fm.skip(54);

      // 4 - Palette Length (including these header fields) (776)
      FieldValidator.checkEquals(fm.readInt(), 776);
      ...
      // 4 - Image Data Length (including these fields)
      // 2 - Unknown (1)
      fm.skip(6);
