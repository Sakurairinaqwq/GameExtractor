...
**********************************************************************************************
**/
public class Viewer_CSV extends ViewerPlugin {
  ...
  **/
  public Viewer_CSV() {
    super("CSV", "CSV (Comma-Separated Values)");
    setExtensions("csv");

    setGames("Generic CSV Table");
    setPlatforms("PC");
  ...
  **/
  ...
  public void write(PreviewPanel panel, FileManipulator fm) {
    try {
      ...
      for (int i = 1; i < numHeaderColumns; i++) { // all subsequent values have a comma to separate them
      ...
      for (int k = 0; k < numRows; k++) {
        ...
        for (int i = 1; i < numColumns; i++) { // all subsequent values have a comma to separate them
