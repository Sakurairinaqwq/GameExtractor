...
import org.watto.ge.plugin.archive.Plugin_SPR_SPRITEFILE;
...
**********************************************************************************************
**/
public class Viewer_SPR_SPRITEFILE_SPRTEX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_SPR_SPRITEFILE_SPRTEX() {
    super("SPR_SPRITEFILE_SPRTEX", "SPR_SPRITEFILE_SPRTEX Image");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_SPR_SPRITEFILE) {
        rating += 50;
      }
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // 1 - Coldep (1=Paletted, 4=RGBA colors)
      ...
      if (imageFormat == 1) {
        ...
        ErrorLogger.log("[Viewer_SPR_SPRITEFILE_SPRTEX] Unknown Image Format: " + imageFormat);
        return null;
      }
