...
import org.watto.ge.plugin.archive.Plugin_ARC_ARCV410;
...
**********************************************************************************************
**/
public class Viewer_ARC_ARCV410_SPX extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_ARC_ARCV410_SPX() {
    super("ARC_ARCV410_SPX", "ARC_ARCV410_SPX Audio");
    setExtensions("spx");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_ARC_ARCV410) {
        rating += 50;
      }
  ...
  **/
  ...
  public PreviewPanel read(FileManipulator fm) {
    try {
      ...
      // X - Raw Audio Data
      int dataLength = (int) (fm.getLength() - 32);
      byte[] dataBytes = fm.readBytes(dataLength);

      // Convert the audio file to a WAV format
      byte[] wavHeader = Exporter_Custom_WAV_RawAudio.getInstance().pcmwav_header(frequency, (short) channels, (short) bitrate, dataLength, (short) 0x0001, -1, (short) -1, null);
