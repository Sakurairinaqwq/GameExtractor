...
import org.watto.ge.plugin.archive.Plugin_FORGEDAT;
...
**********************************************************************************************
**/
public class Viewer_FORGEDAT_MAP extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_FORGEDAT_MAP() {
    super("FORGEDAT_MAP", "FORGEDAT_MAP Image");
    setExtensions("map");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_FORGEDAT) {
        rating += 50;
      }
  ...
  **/
  ...
  public ImageResource readThumbnail(FileManipulator fm) {
    try {
      ...
      // 4 - Image Format (2=DXT1, 4=DXT3, 5=DXT5, 6=BC5)
      ...
      if (imageFormat == 2) {
        ...
        ErrorLogger.log("[Viewer_FORGEDAT_MAP] Unknown Image Format: " + imageFormat);
        return null;
      }
