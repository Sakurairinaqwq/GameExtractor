...
import org.watto.ge.plugin.archive.Plugin_GHA_GHA;
...
**********************************************************************************************
**/
public class Viewer_GHA_GHA_GHW_GHW extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_GHA_GHA_GHW_GHW() {
    super("GHA_GHA_GHW_GHW", "GHA_GHA_GHW_GHW Audio");
    setExtensions("ghw");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (plugin instanceof Plugin_GHA_GHA) {
        rating += 50;
      }
      ...
      if (fm.readString(4).equals("GH_W")) {
        rating += 25;
      }
  ...
  **/
  ...
  public PreviewPanel read(FileManipulator fm) {
    try {
      ...
      // Skip the stuff at the beginning
      fm.skip(16);

      // X - Raw Audio Data
      int dataLength = (int) (fm.getLength() - 16);
      byte[] dataBytes = fm.readBytes(dataLength);

      // Convert the audio file to a WAV format
      byte[] wavHeader = Exporter_Custom_WAV_RawAudio.getInstance().pcmwav_header(22050, (short) 1, (short) 8, dataLength, (short) 0x0001, -1, (short) -1, null);
      ...
      ErrorLogger.log("[Viewer_GHA_GHA_GHW_GHW] Could not open audio file");
      return null;
    }
    catch (Throwable t) {
      logError(t);
