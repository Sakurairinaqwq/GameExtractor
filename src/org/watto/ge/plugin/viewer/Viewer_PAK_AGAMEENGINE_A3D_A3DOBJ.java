...
import org.watto.ge.plugin.archive.Plugin_PAK_AGAMEENGINE;
...
**********************************************************************************************
**/
public class Viewer_PAK_AGAMEENGINE_A3D_A3DOBJ extends ViewerPlugin {
  ...
  **********************************************************************************************
  **/
  public Viewer_PAK_AGAMEENGINE_A3D_A3DOBJ() {
    super("PAK_AGAMEENGINE_A3D_A3DOBJ", "PAK_AGAMEENGINE_A3D_A3DOBJ Model");
    setExtensions("a3d");
  ...
  **/
  ...
  public int getMatchRating(FileManipulator fm) {
    try {
      ...
      if (readPlugin instanceof Plugin_PAK_AGAMEENGINE) {
        rating += 50;
      }
      ...
      if (fm.readString(7).equals("A3d-Obj")) {
        rating += 20;
      }
  ...
  public PreviewPanel read(FileManipulator fm) {
    ...
    try {
      ...
      while (fm.getOffset() < arcSize) {
        // 32 - Header
        String header = fm.readNullString(32);
        ...
        if (header.equals("--- Vert Data ---")) {
          ...
          for (int i = 0, j = 0, k = 0; i < numVertices; i++, j += 3, k += 2) {
            ...
            // 4 - Tex-Coord U
            // 4 - Tex-Coord V
            float uTex = fm.readFloat();
            float vTex = fm.readFloat();
        ...
        else if (header.equals("--- Face Data ---")) {
          // FACES
        ...
        if (faces != null && points != null && normals != null && texCoords != null) {
          ...
          break; // stop reading - we have a full mesh
        }
      }
