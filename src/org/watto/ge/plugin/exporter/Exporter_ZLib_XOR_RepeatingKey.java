...
public class Exporter_ZLib_XOR_RepeatingKey extends ExporterPlugin {

  static Exporter_ZLib_XOR_RepeatingKey instance = new Exporter_ZLib_XOR_RepeatingKey();
  ...
  **********************************************************************************************
  **/
  public static Exporter_ZLib_XOR_RepeatingKey getInstance() {
    return instance;
  }
  ...
  **********************************************************************************************
  **/
  public Exporter_ZLib_XOR_RepeatingKey() {
  ...
  **********************************************************************************************
  **/
  public Exporter_ZLib_XOR_RepeatingKey(int[] xorKey) {
    setName("ZLib Compression operating on XOR'd data");
    this.xorKey = xorKey;
  ...
  **********************************************************************************************
  **/
  public Exporter_ZLib_XOR_RepeatingKey(int[] xorKey, int keyPos) {
    setName("ZLib Compression operating on XOR'd data");
    this.xorKey = xorKey;
    this.keyLength = xorKey.length;
