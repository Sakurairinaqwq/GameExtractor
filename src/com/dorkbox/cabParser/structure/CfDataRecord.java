...
import com.dorkbox.bytes.LittleEndian;
...
public final class CfDataRecord {
  ...
  private int checksum(byte[] bytes) {
    ...
    return com.dorkbox.cabParser.Checksum.calculate(bytes, this.cbData, com.dorkbox.cabParser.Checksum.calculate(arrayOfByte, 4, 0));
  }
